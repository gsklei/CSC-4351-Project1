// Generated from gLexer.g4 by ANTLR 4.13.2
...
public class gLexer extends Lexer {
	...
	public static final int
		...
		HEX_LITERAL=39, OCTAL_LITERAL=40, DECIMAL_LITERAL=41, ID=42;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"HEX_LITERAL", "OCTAL_LITERAL", "DECIMAL_LITERAL", "ID"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BANG", "SEMI", "COLON", "LBRACK", "RBRACK", "STRING_LITERAL", "HEX_LITERAL", 
			"OCTAL_LITERAL", "DECIMAL_LITERAL", "ID"
		};
	}
